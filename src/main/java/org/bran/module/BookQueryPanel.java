...
public class BookQueryPanel extends JPanel {
	...
	public BookQueryPanel(){
		...
		query.setMaximumSize(new Dimension(500, 100));
		minPanel1.add(query);
		...
		preDate.setMaximumSize(new Dimension(500, 100));
		nexDate=new DatePanel();
		nexDate.setMaximumSize(new Dimension(500, 100));
		minPanel2.add(Box.createVerticalGlue());
		minPanel2.add(preDate);
		minPanel2.add(new JLabel("至"));
		...
		sp.add(panel2, JSplitPane.BOTTOM);
	}
